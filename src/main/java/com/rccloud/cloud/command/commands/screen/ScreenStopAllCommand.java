...
public class ScreenStopAllCommand {

    public static void onScreen(String[] args) {
        APIUtils.runCommand("pkill screen");
        RCCloud.getConsoleManager().sendMessage(RCCloud.getCloudManager().getLangProperties().getProperty("all_screen_stopped"), MessageType.SAMELINE); //TODO Translations & DONT KILL SCREENS
    }
}
